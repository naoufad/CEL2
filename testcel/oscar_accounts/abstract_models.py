...
class IPAddressRecord(models.Model):
    ip_address = models.GenericIPAddressField(_("IP address"),default='192.0.2.30', unique=True)
    ...
    # between attempts
    FREEZE_THRESHOLD = 10#3 seuil de tentative de blockage tempraire 

    # Above this threshold, you are blocked indefinitely
    BLOCK_THRESHOLD = 20#10 seuil de tentative de blockage indefinie

    # Blocking period (in seconds)
    COOLING_OFF_PERIOD = 5 * 60 # temps d'attente pour une blocage temporaire IP
