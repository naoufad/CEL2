...
class AbstractAddress(models.Model):
    ...
    MORONI,MITSAMUDU,FOMBONI,BAMB,HAMB,MBA_OUEST,MBA_EST,OICHILI,HAMAHAME,MITSAMIH,ITSANDRA,MREMANI,DOMONI,OUANI,SIMA,NGOUMACHOI,DJANDO,MBOUDE=('Moroni Ville', 'Mitsamudu Anjouan','Fomboni Moheli','Bambao Ngazidja','Hambou Ngazidja','Mbadjini Ouest','Mbadjini Est','Ouachili Ngazidja','Hamahamet Ngazidja','Mitsamihuli Ngazidja','Itsandra Ngazidja','Mremani Anjouan','Domoni Anjouan','Ouani Anjouan','Sima Anjouan','Ngoumachoi Moheli','Djando Moheli','Mboudé Ngazidja')


    REGION_CHOICES=((MORONI,('Moroni Ville')),
    ...
    NGA, ANJ, MOH, MAY = ('Ngazidja', 'Anjouan', 'Moheli',
                          'Mayotte')
    ILE_CHOICES = (
        (NGA, ("Ngazidja")),
        (ANJ, ("Anjouan")),
    ...
    title = models.CharField(
        pgettext_lazy(u"Treatment Pronouns for the customer", u"Civilité"),
    ...
    line2 = models.CharField(max_length=300, choices=REGION_CHOICES,
                             verbose_name='Region du bénéficiaire',
                              default='')
    line3 = models.CharField(max_length=250, choices=ILE_CHOICES,
...
class AbstractShippingAddress(AbstractAddress):
    ...
    phone_number = PhoneNumberField(
        ...
        help_text=("N'oubliez pas le code +269. S'il s'agit de transfert de crédit, mettez le numéro du bénéficiaire"))
    notes = models.TextField(
        blank=True, verbose_name=_('Consignes de livraison'),
        help_text=_("Merci de nous transmettre toutes vos instructions de livraison afin que nous  puissions livrer votre colis dans les meilleures délais"))
