...
# Ajout pour rendre user_account dispo sur profil
...
class AccountRegistrationView(RegisterUserMixin, generic.FormView):
    ...
    template_name = 'yous/customer/registrations.html'
...
class AccountAuthView(RegisterUserMixin, generic.TemplateView):
    ...
    """
    template_name = 'yous/customer/login_registrations.html'
...
class ProfileView(PageTitleMixin, generic.TemplateView):
    template_name = 'yous/customer/profile/profile.html'
...
class ProfileUpdateView(PageTitleMixin, generic.FormView):
    ...
    template_name = 'yous/customer/profile/profile_form.html'
...
class ProfileDeleteView(PageTitleMixin, generic.FormView):
    ...
    template_name = 'yous/customer/profile/profile_delete.html'
...
class ChangePasswordView(PageTitleMixin, generic.FormView):
    ...
    template_name = 'yous/customer/profile/change_password_form.html'
...
class EmailHistoryView(PageTitleMixin, generic.ListView):
    ...
    template_name = 'yous/customer/email/email_list.html'
...
class EmailDetailView(PageTitleMixin, generic.DetailView):
    """Customer email"""
    template_name = "yous/customer/email/email_detail.html"
...
class OrderHistoryView(PageTitleMixin, generic.ListView):
    ...
    template_name = 'yous/customer/order/order_list.html'
...
class OrderDetailView(PageTitleMixin, PostActionMixin, generic.DetailView):
    ...
    def get_template_names(self):
        return ["yous/customer/order/order_detail.html"]
...
class AnonymousOrderDetailView(generic.DetailView):
    model = Order
    template_name = "yous/customer/anon_order.html"
...
class AddressListView(PageTitleMixin, generic.ListView):
    ...
    template_name = 'yous/customer/address/address_list.html'
...
class AddressCreateView(PageTitleMixin, generic.CreateView):
    ...
    model = UserAddress
    template_name = 'yous/customer/address/address_form.html'
    active_tab = 'addresses'
...
class AddressDeleteView(PageTitleMixin, generic.DeleteView):
    model = UserAddress
    template_name = "yous/customer/address/address_delete.html"
