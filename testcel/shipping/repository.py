...
class Repository(object):
    ...
    weightbased_set = models.WeightBased.objects.all() # Ajout methods sur le poids du panier
    methods =tuple(weightbased_set)+ ( shipping_methods.Free(),
                                       shipping_methods.NoShippingRequired(),
                                       shipping_methods.FixedPrice(),
                                       shipping_methods.Region2(),
                                       shipping_methods.Region3(),
                                       shipping_methods.Region4(),
                        
    ) # Methods poids du panier
